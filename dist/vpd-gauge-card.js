 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ct, defineProperty: dt, getOwnPropertyDescriptor: ut, getOwnPropertyNames: _t, getOwnPropertySymbols: gt, getPrototypeOf: pt } = Object, E = globalThis, Ee = E.trustedTypes, ft = Ee ? Ee.emptyScript : "", J = E.reactiveElementPolyfillSupport, P = (r, e) => r, he = { toAttribute(r, e) {
  switch (e) {
    case Boolean:
      r = r ? ft : null;
      break;
  ...
  return t;
} }, et = (r, e) => !ct(r, e), ye = { attribute: !0, type: String, converter: he, reflect: !1, useDefault: !1, hasChanged: et };
var je, Be;
(je = Symbol.metadata) != null || (Symbol.metadata = Symbol("metadata")), (Be = E.litPropertyMetadata) != null || (E.litPropertyMetadata = /* @__PURE__ */ new WeakMap());
let L = class extends HTMLElement {
  ...
  static getPropertyOptions(e) {
    var t;
    return (t = this.elementProperties.get(e)) != null ? t : ye;
  }
  static _$Ei() {
...
var Xe;
L.elementStyles = [], L.shadowRootOptions = { mode: "open" }, L[P("elementProperties")] = /* @__PURE__ */ new Map(), L[P("finalized")] = /* @__PURE__ */ new Map(), J == null || J({ ReactiveElement: L }), ((Xe = E.reactiveElementVersions) != null ? Xe : E.reactiveElementVersions = []).push("2.1.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), we = /'/g, be = /"/g, it = /^(?:script|style|textarea|title)$/i, Et = (r) => (e, ...t) => ({ _$litType$: r, strings: e, values: t }), C = Et(1), H = Symbol.for("lit-noChange"), u = Symbol.for("lit-nothing"), Se = /* @__PURE__ */ new WeakMap(), w = S.createTreeWalker(S, 129);
function nt(r, e) {
...
class V {
  constructor({ strings: e, _$litType$: t }, s) {
    ...
    this.parts = [];
    let o = 0, n = 0;
    const l = e.length - 1, a = this.parts, [h, c] = yt(e, t);
...
class Ht extends N {
  ...
  render() {
    ...
    const t = this._config[te] || "", s = this._config[q] || "", i = this._config[W] || "", o = this._config[z] || "", n = (O = this._config[se]) != null ? O : Re, l = (y = this._config[ie]) != null ? y : De, a = (v = this._config[ne]) != null ? v : He, h = (R = this._config[oe]) != null ? R : Ue, c = this._config[Oe] || Ot, d = this._config[xe] || xt, _ = this._config[Te] || Tt, g = this._config[Le] || Lt, p = this._config[Ne] || Nt;
    return C`
...
class Ut extends N {
  constructor() {
    ...
    T(this, "_calculateSegments", () => {
      ...
      const R = [{ from: i, color: h }, { from: l, color: c }, { from: y, color: d }, { from: v, color: _ }, { from: a, color: g }];
      R.sort((f, F) => f.from - F.from);
      const m = R.filter((f, F, pe) => !(f.from < i || F < pe.length - 1 && pe[F + 1].from === f.from));
      if (m.length === 0 || m[0].from > i) {
        let f = h;
        i >= a ? f = g : i >= v ? f = _ : i >= y ? f = d : i >= l && (f = c), m.unshift({ from: i, color: f }), m.length > 1 && m[1].from === m[0].from && m.shift();
      }
      return m;
    });
  }
  ...
  setConfig(t) {
    ...
    this.config = x(x({}, s), t), delete this.config[CONF_NEEDLE], console.log("VPD Gauge Card Config Set:", this.config), this.hass && this.requestUpdate();
  }
  render() {
    var o, n;
